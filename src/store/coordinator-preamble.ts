 ...
 */
export const COORDINATOR_PREAMBLE = `[COORDINATOR MODE] You are a coordinating agent inside SY CODE. \
...
RULES:
1. You MUST NOT use your built-in Agent tool to spawn new SY CODE tasks — you MUST use \
